  ...
  const entitySchemas = {
    ...
    Plans: {
      ...
      fields: [
        ...
        { name: 'pcp_copay', type: 'Decimal', description: 'Primary care physician copay' },
        { name: 'specialist_copay', type: 'Decimal', description: 'Specialist copay' },
        { name: 'er_copay', type: 'Decimal', description: 'Emergency room copay' },
        { name: 'urgent_copay', type: 'Decimal', description: 'Urgent care copay' },
        { name: 'coinsurance_percentage', type: 'Decimal', description: 'Coinsurance rate %' },
    ...
    Benefits: {
      ...
      fields: [
        ...
        { name: 'category', type: 'String', description: 'Medical/Dental/Vision/Behavioral' },
        ...
        { name: 'deductible_applies', type: 'Boolean', description: 'Deductible applies flag' },
        { name: 'description', type: 'String', description: 'Benefit description' },
        { name: 'annual_limit', type: 'Decimal', description: 'Annual benefit limit' },
    ...
    Providers: {
      ...
      fields: [
        ...
        { name: 'type', type: 'Enum', description: 'Individual/Facility/Group' },
        { name: 'specialty', type: 'String', description: 'Medical specialty' },
        { name: 'tax_id', type: 'String', description: 'Tax ID/SSN' },
        { name: 'address', type: 'String', description: 'Practice address' },
    ...
    Members: {
      ...
      fields: [
        ...
        { name: 'subscriber_id', type: 'UUID', description: 'Subscriber/primary member reference' },
        { name: 'employer_id', type: 'UUID (FK)', description: 'Reference to employer' },
        { name: 'plan_id', type: 'UUID (FK)', description: 'Reference to plan' },
        ...
        { name: 'address', type: 'String', description: 'Mailing address' },
    ...
    'Medical Claims': {
      ...
      fields: [
        ...
        { name: 'claim_type', type: 'Enum', description: 'Professional/Institutional/Pharmacy' },
        { name: 'claim_status', type: 'Enum', description: 'Paid/Denied/Pending/Appeal' },
        ...
        { name: 'secondary_diagnosis', type: 'Array[String]', description: 'Secondary diagnoses' },
        { name: 'place_of_service', type: 'String', description: 'Service location' },
    ...
    'Pharmacy Claims': {
      ...
      fields: [
        ...
        { name: 'formulary_status', type: 'Enum', description: 'Preferred/Non-Preferred/Specialist' },
    ...
    Authorizations: {
      ...
      fields: [
        ...
        { name: 'plan_id', type: 'UUID (FK)', description: 'Reference to plan' },
        { name: 'provider_id', type: 'UUID (FK)', description: 'Reference to provider' },
        { name: 'auth_type', type: 'Enum', description: 'Prior Auth/Concurrent/Retrospective' },
        ...
        { name: 'urgency', type: 'Enum', description: 'Routine/Urgent/Emergency' },
